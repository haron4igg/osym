...
public class one_img extends Applet{
	...
	public void init(){
		...
		vision.addItem("зависимость потенциала U41 от времени");
		vision.addItem("зависимость потенциала U42 от времени");
		vision.addItem("зависимость потенциала U43 от времени");
		vision.addItem("зависимость потенциала U51 от времени");
		vision.addItem("зависимость потенциала U52 от времени");
		vision.addItem("зависимость потенциала U53 от времени");
		vision.addItem("зависимость потенциала U61 от времени");
		vision.addItem("зависимость потенциала U62 от времени");
		vision.addItem("зависимость потенциала U63 от времени");
		vision.addItem("зависимость потенциала U71 от времени");
		vision.addItem("зависимость потенциала U72 от времени");
		vision.addItem("зависимость потенциала U73 от времени");
		vision.addItem("зависимость потенциала U81 от времени");
		vision.addItem("зависимость потенциала U82 от времени");
		vision.addItem("зависимость потенциала U83 от времени");
		...
		vision.addItem("зависимость скорости потенциала U41 от времени");
		vision.addItem("зависимость скорости потенциала U42 от времени");
		vision.addItem("зависимость скорости потенциала U43 от времени");
		vision.addItem("зависимость скорости потенциала U51 от времени");
		vision.addItem("зависимость скорости потенциала U52 от времени");
		vision.addItem("зависимость скорости потенциала U53 от времени");
		vision.addItem("зависимость скорости потенциала U61 от времени");
		vision.addItem("зависимость скорости потенциала U62 от времени");
		vision.addItem("зависимость скорости потенциала U63 от времени");
		vision.addItem("зависимость скорости потенциала U71 от времени");
		vision.addItem("зависимость скорости потенциала U72 от времени");
		vision.addItem("зависимость скорости потенциала U73 от времени");
		vision.addItem("зависимость скорости потенциала U81 от времени");
		vision.addItem("зависимость скорости потенциала U82 от времени");
		vision.addItem("зависимость скорости потенциала U83 от времени");
		...
		vision.addItem("фазовая траектория осциллятора для потенциала U41");
		vision.addItem("фазовая траектория осциллятора для потенциала U42");
		vision.addItem("фазовая траектория осциллятора для потенциала U43");
		vision.addItem("фазовая траектория осциллятора для потенциала U51");
		vision.addItem("фазовая траектория осциллятора для потенциала U52");
		vision.addItem("фазовая траектория осциллятора для потенциала U53");
		vision.addItem("фазовая траектория осциллятора для потенциала U61");
		vision.addItem("фазовая траектория осциллятора для потенциала U62");
		vision.addItem("фазовая траектория осциллятора для потенциала U63");
		vision.addItem("фазовая траектория осциллятора для потенциала U71");
		vision.addItem("фазовая траектория осциллятора для потенциала U72");
		vision.addItem("фазовая траектория осциллятора для потенциала U73");
		vision.addItem("фазовая траектория осциллятора для потенциала U81");
		vision.addItem("фазовая траектория осциллятора для потенциала U82");
		vision.addItem("фазовая траектория осциллятора для потенциала U83");
		...
		vision.addItem("траектория осциллятора на плоскости {U41,U42,U43}");
		vision.addItem("траектория осциллятора на плоскости {U51,U52,U53}");
		vision.addItem("траектория осциллятора на плоскости {U61,U62,U63}");
		vision.addItem("траектория осциллятора на плоскости {U71,U72,U73}");
		vision.addItem("траектория осциллятора на плоскости {U81,U82,U83}");
		...
		vision.addItem("траектория осциллятора на плоскости {U11,U41,U71}");
		vision.addItem("траектория осциллятора на плоскости {U12,U42,U72}");
		vision.addItem("траектория осциллятора на плоскости {U13,U43,U73}");
		vision.addItem("траектория осциллятора на плоскости {U11,U51,U61}");
		vision.addItem("траектория осциллятора на плоскости {U12,U52,U62}");
		vision.addItem("траектория осциллятора на плоскости {U13,U53,U63}");
		vision.addItem("траектория осциллятора на плоскости {U21,U41,U61}");
		vision.addItem("траектория осциллятора на плоскости {U22,U42,U62}");
		vision.addItem("траектория осциллятора на плоскости {U23,U43,U63}");
		vision.addItem("траектория осциллятора на плоскости {U21,U51,U71}");
		vision.addItem("траектория осциллятора на плоскости {U22,U52,U72}");
		vision.addItem("траектория осциллятора на плоскости {U23,U53,U73}");
		vision.addItem("траектория осциллятора на плоскости {Uv+1,U41,U51}");
		vision.addItem("траектория осциллятора на плоскости {Uv+2,U42,U52}");
		vision.addItem("траектория осциллятора на плоскости {Uv+3,U43,U53}");
		vision.addItem("траектория осциллятора на плоскости {Uv-1,U61,U71}");
		vision.addItem("траектория осциллятора на плоскости {Uv-2,U62,U72}");
		vision.addItem("траектория осциллятора на плоскости {Uv-3,U63,U73}");
		vision.addItem("траектория осциллятора на плоскости {123}");
		vision.addItem("траектория осциллятора на плоскости {147}");
		vision.addItem("траектория осциллятора на плоскости {156}");
		vision.addItem("траектория осциллятора на плоскости {246}");
		vision.addItem("траектория осциллятора на плоскости {257}");
		vision.addItem("траектория осциллятора на плоскости {3458}");
		vision.addItem("траектория осциллятора на плоскости {3678}");
		vision.addItem("неголономные связи");
		vision.addItem("переливы энергии");
		vision.addItem("плотность u1");
		vision.addItem("плотность u2");
		vision.addItem("плотность u3");
		vision.addItem("плотность u4");
		vision.addItem("плотность u5");
		vision.addItem("плотность u6");
		vision.addItem("плотность u7");
		vision.addItem("плотность u8");
		vision.addItem("плотность u1_123");
		vision.addItem("плотность u2_123");
		vision.addItem("плотность u3_123");
		vision.addItem("плотность u1_147");
		vision.addItem("плотность u2_147");
		vision.addItem("плотность u3_147");
		vision.addItem("плотность u1_156");
		vision.addItem("плотность u2_156");
		vision.addItem("плотность u3_156");
		vision.addItem("плотность u1_246");
		vision.addItem("плотность u2_246");
		vision.addItem("плотность u3_246");
		vision.addItem("плотность u1_257");
		vision.addItem("плотность u2_257");
		vision.addItem("плотность u3_257");
		vision.addItem("плотность u1_v+45");
		vision.addItem("плотность u2_v+45");
		vision.addItem("плотность u3_v+45");
		vision.addItem("плотность u1_v-67");
		vision.addItem("плотность u2_v-67");
		vision.addItem("плотность u3_v-67");
		vision.addItem("плотность 123");
		vision.addItem("плотность 147");
		vision.addItem("плотность 156");
		vision.addItem("плотность 246");
		vision.addItem("плотность 257");
		vision.addItem("плотность 3458");
		vision.addItem("плотность 3678");
		vision.select(0);
		...
		else if(myvision < 49)
		{
			...
			if(first == 1)
			{
				while (tlast < tb)
		        {
		              ...
		              g.fillOval(wndX(i*h, 49), wndY(av[index], index), 1, 1);
		              tlast += h;
		        }
			}
			else if(myvision == 1)
			...
			for(int j = 0; j < gol; j++)
				for(int j2 = 0; j2 < 8; j2++)
					if(negol[j2][j] > -16)
					{
						...
						g.fillOval(wndX(negol[8][j], 49), wndY(negol[j2][j], 48), 1, 1);
					}
			/*
			Image img1;
		...
		for(int j1 = 0; j1 < 420; j1++)
  			for(int j2 = 0; j2 < 420; j2++)
				if(mas[j1][j2] != 100)
				{
					...
					Color colC = new Color(col[0], col[1], col[2]);
		  		  	g.setColor(colC);
		            g.fillOval(j1+wndXMin-10, j2+wndYMin-10, 1, 1);
				}
	...
	public void zym()
	{
		...
		if(mouse[myvision] == 1)
		{
			if(XDown < XUp)
			{
				istart = (long)(utime[48][XDown - wndXMin + 1]/h);
				iend = (long)(utime[48][XUp - wndXMin + 1]/h);
			...
			{
				iend = (long)(utime[48][XDown - wndXMin + 1]/h);
				istart = (long)(utime[48][XUp - wndXMin + 1]/h);
		...
		else
		{
			if(XDown < XUp)
			{
				istart = (long)(utimezym[48][XDown - wndXMin + 1]/h);
				iend = (long)(utimezym[48][XUp - wndXMin + 1]/h);
			...
			{
				iend = (long)(utimezym[48][XDown - wndXMin + 1]/h);
				istart = (long)(utimezym[48][XUp - wndXMin + 1]/h);
		...
		if(myvision != 0)
		{
		maxMin[50][0] = istart*h; maxMin[50][1] = iend*h;
		...
		while (istart < iend)
        {
              ...
              if(av[index] >= maxMin[51][0] && av[index] <= maxMin[51][1])
            	  g.fillOval(wndX(istart*h, 50), wndY(av[index], 51), 1, 1);
              ...
              px = wndX(istart*h, 50);
	      	  if(utimezym[48][px - wndXMin + 1] == -1)
	      	  {
	      			...
	      			utimezym[48][px - wndXMin + 1] = istart*h;
	      	   }
              istart++;
		}
		}
