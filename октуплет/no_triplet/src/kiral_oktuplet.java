...
public class kiral_oktuplet extends Applet{
	...
	int sizeX = 1060, sizeY = 520, sizePanel = (int)(wndXMin) - 100;
	...
	public void init(){
		...
		vision.addItem("переливы потенциальной энергии");
		vision.select(0);
	...
	public void draw()
	{
		...
		if(myvision == 0)
		{
			Color col = new Color(0,0,139);
		  	...
		  	if(first == 1 && myfile == 0)
		  	{
		  		...
		  		maxMin[48][0] = -16; maxMin[48][1] = -10.0;
		...
		else if(myvision == 111)
		{
			int col[] = new int[3];
			
			maxMin[50][0] = 0; maxMin[50][1] = 0.0005;
			shcala(49, 50);
	...
	{   
		...
		maxMin[50][0] = 0; maxMin[50][1] = 0.0005; 
		py = wndY(U123(), 50);
		img_U[px - wndXMin + 1][py - wndYMin + 1] = 1;
		py = wndY(U147(), 50);
		img_U[px - wndXMin + 1][py - wndYMin + 1] = 2;
		py = wndY(U156(), 50);
		img_U[px - wndXMin + 1][py - wndYMin + 1] = 3;
		py = wndY(U246(), 50);
		img_U[px - wndXMin + 1][py - wndYMin + 1] = 4;
		py = wndY(U257(), 50);
		img_U[px - wndXMin + 1][py - wndYMin + 1] = 5;
		py = wndY(U3458(), 50);
		img_U[px - wndXMin + 1][py - wndYMin + 1] = 6;
		py = wndY(U3678(), 50);
		img_U[px - wndXMin + 1][py - wndYMin + 1] = 7;
		
		maxMin[50][0] = 0; maxMin[50][1] = 1; 
	
		py = wndY(U123()+Kone1(1,2,3,0.5), 50);
		img_E[px - wndXMin + 1][py - wndYMin + 1] = 1;
		py = wndY(U147()+Kone1(1,4,7,0.25), 50);
		img_E[px - wndXMin + 1][py - wndYMin + 1] = 2;
		py = wndY(U156()+Kone1(1,5,6,0.25), 50);
		img_E[px - wndXMin + 1][py - wndYMin + 1] = 3;
		py = wndY(U246()+Kone1(2,4,6,0.25), 50);
		img_E[px - wndXMin + 1][py - wndYMin + 1] = 4;
		py = wndY(U257()+Kone1(2,5,7,0.25), 50);
		...
		for(int i = 0; i < 3; i++)
		{
			v3[i] = 0.5*(av[30+i]+mk3*av[45+i]);
			v1[i] = av[33+i];
			v2[i] = av[36+i];
		}
		py = wndY(U3458()+Kone(v1,v2,v3), 50);
		...
		py = wndY(U3678()+Kone(v1,v2,v3), 50);
	...
	public void kiral_func(double sh)
	{
    	double[] msign = new double[9];
    	test_kiral(msign, 0);
    	
    	double vec1[] = {0.5*(av[6]+mk3*av[21]), 0.5*(av[7]+mk3*av[22]), 0.5*(av[8]+mk3*av[23])};
    	double vec2[] = {av[9], av[10], av[11]};
    	double vec3[] = {av[12], av[13], av[14]};
    	
    	msign[5] = kiral_vec(vec1,vec2,vec3);
    	
    	for(int i = 0; i < 3; i++)
    	{
    		vec1[i] = 0.5*(av[6+i]-mk3*av[21+i]);
    		vec2[i] = av[18+i];
    		vec3[i] = av[15+i];
    	}
	...
	public void zym()
	{
		...
		if(myvision != 0)
		{
		maxMin[20][0] = istart*h; maxMin[20][1] = iend*h;
